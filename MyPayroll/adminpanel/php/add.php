...
if ($_SERVER["REQUEST_METHOD"] == "POST") {
    ...
    // Calculăm variabilele suplimentare
    ...
    $sql = "INSERT INTO salariati (salariat, Functia, Zile_lucrate, Ore_lucrate, Salariu_brut, Concediu_medical, CAS, CASS, Tichete_masa, Baza_impozit, Impozit_pe_venit, Salariu_net, email, valoare_tichet, telefon) 
            VALUES (?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?)";
    $stmt = $con->prepare($sql);
    $stmt->bind_param("ssiiiddddiidsss", $salariat, $Functia, $Zile_lucrate, $Ore_lucrate, $Salariu_brut, $Concediu_medical, $CAS, $CASS, $Tichete_masa, $Baza_impozit, $Impozit_pe_venit, $Salariu_net, $email, $valoare_tichet, $telefon);
    
    if ($stmt->execute()) {
        // Redirect către pagina principală cu un mesaj de succes
        header("Location: ../adminpanel.php?message=Angajatul a fost adăugat cu succes.");
        exit();
    } else {
        // Redirect către pagina principală cu un mesaj de eroare
        header("Location: ../adminpanel.php?message=Eroare la adăugarea angajatului: " . $stmt->error);
        exit();
    }
}
?>
              ...
              <div class="table-responsive">
                ...
                >
                  ...
                  <td>  <div class="form-group">
                        ...
                        <input type="text" class="form-control" id="salariat" name="salariat"  required>
                    </div> </td>
                   <td> <div class="form-group">
                        <label for="Functia">Functia</label>
                        <input type="text" class="form-control" id="Functia" name="Functia"  required>
                    </div></td>
                   <td> <div class="form-group">
                        <label for="Zile_lucrate">Zile lucrate</label>
                        <input type="number" class="form-control" id="Zile_lucrate" name="Zile_lucrate" required>
                    </div></td>
                    <td> <div class="form-group">
                        <label for="Ore_lucrate">Ore lucrate</label>
                        <input type="number" class="form-control" id="Ore_lucrate" name="Ore_lucrate" >
                    </div></td>
                    <td> <div class="form-group">
                        <label for="Salariu_brut">Salariu brut</label>
                        <input type="number" class="form-control" id="Salariu_brut" name="Salariu_brut"  required>
                    </div></td>
                    <td> <div class="form-group">
                        <label for="Concediu_medical">Concediu</label>
                        <input type="number" class="form-control" id="Concediu_medical" name="Concediu_medical" required>
                    </div></td>
                    <td> <div class="form-group">
                        <label for="CAS">CAS</label>
                        <input type="number" class="form-control" id="CAS" name="CAS" >
                    </div></td>
                    <td> <div class="form-group">
                        <label for="CASS">CASS</label>
                        <input type="number" class="form-control" id="CASS" name="CASS" >
                    </div></td>
                    <td> <div class="form-group">
                        <label for="Tichete_masa">Tichete de masă</label>
                        <input type="number" class="form-control" id="Tichete_masa" name="Tichete_masa" >
                    </div></td>
                    <td> <div class="form-group">
                        <label for="Baza_impozit">Bază impozitabilă</label>
                        <input type="number" class="form-control" id="Baza_impozit" name="Baza_impozit">
                    </div></td>
                    <td> <div class="form-group">
                        <label for="Impozit_pe_venit">Impozit pe venit</label>
                        <input type="number" class="form-control" id="Impozit_pe_venit" name="Impozit_pe_venit" >
                    </div></td>
                    <td> <div class="form-group">
                        <label for="Salariu_net">Salariu net</label>
                        <input type="number" class="form-control" id="Salariu_net" name="Salariu_net" >
                    </div></td>
                    <td><div class="form-group">
                    ...
                    <td> <div class="form-group">
                        <label for="valoare_tichet">Valoare tichet</label>
                        <input type="number" class="form-control" id="valoare_tichet" name="valoare_tichet"  required>
                    </div></td>
                    <td> <div class="form-group">
