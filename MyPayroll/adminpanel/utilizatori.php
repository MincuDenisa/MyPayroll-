        ...
        <div class="col-md-12 mb-3">
          <div class="card">
            <div class="card-header">
              <span><i class="bi bi-table me-2"></i></span>Utilizatori
            </div>
            <div class="card-body">
              <div class="table-responsive">
                ...
                if ($result->num_rows > 0) {
                    ...
                    while($row = $result->fetch_assoc()) {
                        ...
                        <a href='php/edit_user.php?id=" .$row['id'] ."'' class='btn btn-primary btn-sm bi bi-pen'></a>
                        
                        <a href='php/delete_user.php?id=" . $row['id'] . "'' class='btn btn-danger btn-sm bi bi-x-circle' onclick='return confirm(\"Esti sigur ca vrei sa stergi acest utilizator?\");';)></a>
